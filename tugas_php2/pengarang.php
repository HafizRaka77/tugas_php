                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" href="delete_data/delete_pengarang.php?id=<?php echo $data['id_pengarang']?>" role="button" onclick="return confirm('Are you sure to delete this data?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
