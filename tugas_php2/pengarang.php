...
<body>
    ...
    <?php
        ...
        $result = mysqli_query($connection, "SELECT * FROM pengarang");
    ?>
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <p class ="fw-semibold" style="font-size:18px;" >Data Pengarang
                            <a href="add_data/add_pengarang.php" class="btn btn-primary float-end">Add Pengarang</a>
                        </p>
                    </div>
                    <div class="card-body">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $data['alamat'];?></td>
                                     <td>
                                        <a class="btn btn-success btn-sm" href="edit_data/edit_pengarang.php?id=<?php echo $data['id_pengarang']?>">Edit</a>
                                        <a class="btn btn-danger btn-sm" href="delete_data/delete_pengarang.php?id=<?php echo $data['id_pengarang']?>" role="button" onclick="return confirm('Apakah anda yakin untuk menghapus data ini?')">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
