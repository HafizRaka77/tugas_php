                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" href="delete_data/delete_penerbit.php?id=<?php echo $data['id_penerbit']?>" role="button" onclick="return confirm('Are you sure to delete this data?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
