                        ...
                        <form action="../backend/proses_edit_pelanggan.php?id=<?php echo $id; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="pria"<?php if($jenis_kelamin=="pria"){echo "checked";}?>>
                                    <label class="form-check-label">
                                    pria
                                    </label>  
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="wanita" <?php if($jenis_kelamin=="wanita"){echo "checked";}?>>
                                    <label class="form-check-label">
                                    wanita
                                    </label>  
                                </div>
