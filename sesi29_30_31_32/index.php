                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" href="delete_data/delete_pelanggan.php?id=<?php echo $data['id']?>" role="button" onclick="return confirm('Are you sure to delete this data?')">Delete</a>
                                        </td>
                                    </tr>   
                                <?php $no++; } ?>
                            </tbody>
